...
#include <leg_detector_msgs/msg/human.hpp>
#include <leg_detector_msgs/msg/human_array.hpp>
...
private:
    ...
    message_filters::Subscriber<leg_detector_msgs::msg::HumanArray> people_tracked_sub_;
    message_filters::TimeSynchronizer<sensor_msgs::msg::LaserScan, leg_detector_msgs::msg::HumanArray> sync_;
    ...
    void inflated_human_callback(const sensor_msgs::msg::LaserScan::ConstSharedPtr &scan,
                                 const leg_detector_msgs::msg::HumanArray::ConstSharedPtr &people_tracked) {
